...
export function TrainingRegistration() {
    ...
    if (settings.is_open == 0 && !successData) {
        return (
            <div className="min-h-[70vh] flex flex-col items-center justify-center p-4">
                <div className="w-20 h-20 bg-gray-100 rounded-full flex items-center justify-center mb-6">
                    <AlertCircle className="w-10 h-10 text-gray-400" />
                </div>
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Pendaftaran Ditutup</h2>
                <p className="text-gray-500 text-center max-w-md mb-8">
                    Mohon maaf, saat ini belum ada pelatihan publik yang tersedia atau pendaftaran telah ditutup sementara waktu. Silakan pantau terus informasi dari kami.
                </p>
